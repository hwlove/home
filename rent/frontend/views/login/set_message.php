...
<!--form开始-->
								<form class="form-horizontal" role="form" action="index.php?r=login/setmessage" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">
										<i class="icon-leaf green"></i>&nbsp;&nbsp;请输入密码再修改 </label>

										<div class="col-sm-9">
											<input type="password" class="col-xs-10 col-sm-5" id="form-input-readonly" value="" placeholder="<?php echo $back_pwd;?>" name="back_pwd"/>
									...
									<div class="form-group">
										...
										<i class="icon-leaf green"></i>&nbsp;&nbsp;用户名 </label>

										<div class="col-sm-9">
											<input  type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="" placeholder="<?php echo $back_name?>" name="back_name"/>
										</div>
									</div>
