...
<!--form开始-->
								<form class="form-horizontal" role="form" action="index.php?r=index/index" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">
										<i class="icon-leaf green"></i>&nbsp;&nbsp;邮箱 </label>

										<div class="col-sm-9">
											<?php echo $data['back_email'];?>
											<span class="help-inline col-xs-1 col-sm-1">
												<label class="middle">
												</label>
											</span>
