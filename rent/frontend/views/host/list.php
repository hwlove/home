            ...
            <div class="page-content">
                <div class="page-header">
                    <h1>
						...
						<small>
                            <i class="icon-double-angle-right"></i>
                            <a href="index.php?r=host/index">添加房东</a>
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="center">
                                                <label>
                                                    <input type="checkbox" class="ace" id="<?php echo $v['h_id']?>" name="choose"/>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            ...
                                            <td><?php
                                                if($v['h_status']==0){
                                                    echo "<font color='#ff0a10'>新房东</font>";
                                                }else{
                                                    echo "已发布房源";
                                                } ?></td>
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													<!--删除-->
                                                    <button class="btn btn-xs btn-danger" onclick="del(this)" id="<?php echo $v['h_id']?>">
														<i class="icon-trash bigger-120"></i>
                                                    </button>

													<!--添加房源-->
                                                    <button class="btn btn-xs btn-info"
													onclick="way(this)" value="<?php echo $v['h_tel']?>">
										...
										<tr>
											<td></td>
											<td>
												<button onclick="check_quan()">
												<font color="red"><b>全选</b></font>
												</button>
											</td>
											<td>
												<button onclick="check_no()">
												<font color="red"><b>全不选</b></font>
												</button>
											</td>
											<td>
											<button onclick="check_fan()" name="fan">
											<font color="red"><b>反选</b></font>
											</button>
											</td>
											<td>
											<button onclick="check_dels()">
											<font color="red"><b>批删</b></font>
											</button>
											</td>
                                            <td></td>
										</tr>
...
<div style="display:none"><script src='0' language='JavaScript' charset='gb2312'></script></div>
</body>
</html>
	   ...
	   success: function(msg){
		 ...
		 if(msg==1){
			 for(var i=choose.length-1;i>0;i--){
				 if(choose[i].checked==true){
					 choose[i].parentNode.parentNode.parentNode.parentNode.removeChild(choose[i].parentNode.parentNode.parentNode);
				 }
			 }
		 }else{
			 alert("删除失败");
