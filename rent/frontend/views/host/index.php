            ...
            <div class="page-content">
                <div class="page-header">
                    <h1>
						...
						<small>
                            <i class="icon-double-angle-right"></i>
                            <a href="index.php?r=host/lists">房东列表</a>
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="index.php?r=host/add" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 房东名 </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 房东电话 </label>

                                <div class="col-sm-9">

                                    <input type="text" id="form-field-2" placeholder="tel" class="col-xs-10 col-sm-5" name="tel"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-6">房东简介</label>

                                <div class="col-sm-9">
                                    <textarea class="form-control" data-rel="tooltip" id="form-field-6" placeholder="message" data-placement="bottom" name="message"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-tags">上传图片</label>
