...
$form = ActiveForm::begin([
    'action'=>'index.php?r=home/addhome',
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="index.php?r=home/addhome" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 房屋名称 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="给房子起个名字" class="col-xs-10 col-sm-5" name="h_name"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"  for="form-field-1"> 房主电话 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="<?php echo $tel?>" name="h_tel"placeholder="电话" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 房屋位置</label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" placeholder="房屋具体位置" name="h_site" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4">房屋简介</label>

                                <div class="col-sm-9">
                                    <textarea class="form-control" id="form-field-8" name="h_desc" placeholder="房屋简介"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4">房屋配置</label>
                                &nbsp;&nbsp;&nbsp;
                                <input name="form-field-checkbox" id="checkall" type="checkbox" class="ace" />
                                <span class="lbl"> 全选</span>
                                <input name="form-field-checkbox"id="invert" type="checkbox" class="ace" />
                                <span class="lbl"> 反选</span><br/>

                                <div class="col-sm-9">

                                                                    <input name="h_deploy[]" value="床"class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 床</span><input name="h_deploy[]" value="衣柜" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 衣柜</span><input name="h_deploy[]" value="书桌" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 书桌</span><input name="h_deploy[]" value="Wi-Fi" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> Wi-Fi</wi-></span><input name="h_deploy[]" value="洗衣机" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 洗衣机</span><input name="h_deploy[]"  value="热水器" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 热水器</span><input name="h_deploy[]" value="空调" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 空调</span><input name="h_deploy[]"  value="微波炉" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 微波炉</span><input name="h_deploy[]" value="智能锁" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 智能锁</span><input name="h_deploy[]" value="冰箱" class="ace ace-checkbox-2" type="checkbox" />
                                    <span class="lbl"> 冰箱</span>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4">出租类型</label>

                                <div class="col-sm-9">
                                    <label>
                                        <input name="h_type" value="月租" type="radio" class="ace" />
                                        <span class="lbl"> 月租</span>
                                    </label>
                                    <label>
                                        <input name="h_type" value="日租" type="radio" class="ace" />
                                        <span class="lbl"> 日租</span>
                                    </label>
                                    <label>
                                        <input name="h_type" value="整租" type="radio" class="ace" />
                                        <span class="lbl"> 整租</span>
                                    </label>
                                    <label>
                                        <input name="h_type" value="合租" type="radio" class="ace" />
                                        <span class="lbl"> 合租</span>
                                    </label>
                                    <label>
                                        <input name="h_type" value="公寓租" type="radio" class="ace" />
                                        <span class="lbl">公寓租</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-6">房屋面积</label>

                                <div class="col-sm-9">
                                    <input data-rel="tooltip" name="h_acreage" type="text" id="form-field-6" placeholder="面积" title="房屋面积多大啊" data-placement="bottom" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-tags">房屋朝向</label>
                                <div class="col-sm-9">
                                    <select class="width-80 chosen-select" name="h_direction" id="form-field-select-3" data-placeholder="Choose a Country...">
                                        <option value="">&nbsp;</option>
                                        <option value="面朝东"  >面朝东</option>
                                        <option value="面朝西"  >面朝西</option>
                                        <option value="面朝南"  >面朝南</option>
                                        <option value="面朝北"  >面朝北</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4">房屋图片</label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"  for="form-field-4">房屋价格</label>

                                <div class="col-sm-9">
                                    <input type="text" name="h_price" class="input-mini" id="spinner2" />
                                    <div class="space-6"></div>
                                </div>
                            </div>
...
<script type="text/javascript">
        ...
        $("#checkall").click(function(){
            if(this.checked){
                $("input[name='h_deploy[]']").prop("checked",true);
            }else{
                $("input[name='h_deploy[]']").prop("checked",false);
            }
        })

        $("#invert").click(function(){

            $(".col-sm-9 :checkbox").each(function () {
