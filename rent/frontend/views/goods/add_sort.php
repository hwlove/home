...
<!--form开始-->
								<form class="form-horizontal" role="form" action="index.php?r=goods/addgoodssort" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">
										<i class="icon-leaf green"></i>&nbsp;&nbsp;商品分类名称 </label>

										<div class="col-sm-9">
											<input  type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="" placeholder="Goodssort's  name" name="s_name"/>
										</div>

									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> <i class="icon-leaf green"></i>&nbsp;&nbsp;请选择父类:</label>

										<div class="col-sm-9">
											<select name="parent_id">
											<option value="0">
											<?php echo str_repeat("　",4);?>一级分类</option>
											<?php foreach($data as $key=>$val){?>
												
												<option value="<?php echo $val['s_id'];?>">
												<?php echo str_repeat("　",$val['s_level']*4);?>
												<?php echo $val['s_name'];?></option>
