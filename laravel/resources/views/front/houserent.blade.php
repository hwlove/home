...
<div class="buy-sin-single">
			<div class="col-sm-5 middle-side immediate">
					       <h4>房屋信息</h4>
						 <p><span class="bath">房&nbsp;&nbsp;名 &nbsp;&nbsp;</span> <span style="float:right">{{$selhouse->h_name}}</span></p>
					     <p><span class="bath2">床 &nbsp;&nbsp;数&nbsp;&nbsp;&nbsp;&nbsp;</span> <span style="float:right">{{$selhouse->h_bed}} 个</span></p>
					     <p><span class="bath3">房屋面积</span> <span style="float:right">{{$selhouse->h_acreage}}㎡</span></p>
					     <p><span class="bath4">地理位置 </span> <span style="float:right"> {{$selhouse->h_site}}</span></p>
						 <p><span class="bath5">价&nbsp;&nbsp;格&nbsp;&nbsp; </span> <span style="float:right">￥{{$selhouse->h_price}}元</span></p>				 
						<div class="   right-side">
							 <a href="payinfo?price={{$selhouse->h_price}}" class="hvr-sweep-to-right more" >租用</a>
							  <a href="{{URL('addorder?h_name='.$selhouse->h_name.'&h_id='.$selhouse->h_id)}}"  class="hvr-sweep-to-right more" > 在线预约看房</a>
					 </div>
					</div>
			...
			<div class="single-box-right right-immediate">
				...
				<div class="single-box-img ">
					<div class="box-img">
						...
						<a href="#"><img class="img-responsive" src="../uploads/{{$img[$i]}}" alt=""></a>
						<?php }?>
					</div>
					<div class="box-text">
						<p><a href="#">{{$selhouse->h_name}}</a></p>
					...
					<div class="box-text">
						<p><a href="#">{{$selhouse->h_direction}}</a></p>
...
<!--//footer-->
<input type="hidden" value="{{$selhouse->h_site}}" id="place"/>
<div id="div2">
